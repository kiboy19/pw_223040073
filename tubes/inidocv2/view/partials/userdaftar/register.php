          ...
          <div class="pendaftaran">
            ...
            <?php 
              if(isset($_POST['submit'])){
                ...
                $sql = "INSERT INTO `pengguna`(`nama`, `username`, `email`, `password`, `gambar`) VALUES ('$nama', '$username', '$email', '$password', '')";
                if (mysqli_query($userconn, $sql)) {
            ...
            ?>
            <br>
            <p>Sudah punya akun ? <a href="userlogin.php" style="text-decoration:none; color:white; font-weight:bold;">Masuk disini</a></p>
          </div>
        </div>
      </div>
    </section>
