          ...
          <div class="pendaftaran">
            ...
            <?php 
              if(isset($_POST['submit'])){
                ...
                $cek = mysqli_query($userconn, "SELECT * FROM pengguna WHERE email = '".$email."' AND password = '".($pass)."'");
            ...
            ?>
            <br />
            <p>Belum punya akun ? <a href="userdaftar.php" style="text-decoration:none; color:white; font-weight:bold;">Daftar disini</a></p>
          </div>
        </div>
      </div>
    </section>
